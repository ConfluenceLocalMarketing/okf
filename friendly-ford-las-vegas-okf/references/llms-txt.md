...
See [ai-discovery-page.md](https://promptgraph.nyc3.cdn.digitaloceanspaces.com/OKF/friendly-ford-las-vegas/references/ai-discovery-page.md) for the full AI Discovery Hub overview and [prompts.md](https://promptgraph.nyc3.cdn.digitaloceanspaces.com/OKF/friendly-ford-las-vegas/references/prompts.md) for the prompt library.

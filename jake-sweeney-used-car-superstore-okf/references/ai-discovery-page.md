...
The `/prompts` endpoint exposes 10 structured Q&A prompt/response pairs. See [prompts.md](https://promptgraph.nyc3.cdn.digitaloceanspaces.com/OKF/jake-sweeney-used-car-superstore/references/prompts.md) for the full library. Topics include:
...
See [testimonials.md](https://promptgraph.nyc3.cdn.digitaloceanspaces.com/OKF/jake-sweeney-used-car-superstore/references/testimonials.md) for customer review data.
...
See [llms-txt.md](https://promptgraph.nyc3.cdn.digitaloceanspaces.com/OKF/jake-sweeney-used-car-superstore/references/llms-txt.md) for the full directive.

...
The `/prompts` endpoint exposes 59 structured Q&A prompt/response pairs serving as an AI FAQ. See [prompts.md](haselwood-hyundai-okf/references/prompts.md) for the full library. Topics include:
...
The `/testimonials` endpoint exposes customer review data with predominantly 5-star ratings. See [testimonials.md](haselwood-hyundai-okf/references/testimonials.md) for details.
...
See [llms-txt.md](haselwood-hyundai-okf/references/llms-txt.md) for the full llms.txt directive.
See [prompts.md](haselwood-hyundai-okf/references/prompts.md) for the complete Q&A prompt library.
See [testimonials.md](haselwood-hyundai-okf/references/testimonials.md) for customer review data.

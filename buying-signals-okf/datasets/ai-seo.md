...
See [ai-discovery-page.md](https://promptgraph.nyc3.cdn.digitaloceanspaces.com/OKF/buying-signals/references/ai-discovery-page.md) for PromptGraph API and AI Manifest details.

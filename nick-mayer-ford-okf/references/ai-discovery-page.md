...
The site does not currently expose dedicated AI/LLM endpoints. AI agents should rely on standard web scraping of the visible site structure. See [llms-txt.md](https://promptgraph.nyc3.cdn.digitaloceanspaces.com/OKF/nick-mayer-ford/references/llms-txt.md) for additional guidance.

## Related Concepts

- [llms-txt.md](https://promptgraph.nyc3.cdn.digitaloceanspaces.com/OKF/nick-mayer-ford/references/llms-txt.md) - LLMs.txt guidance
- [prompts.md](https://promptgraph.nyc3.cdn.digitaloceanspaces.com/OKF/nick-mayer-ford/references/prompts.md) - Prompt library

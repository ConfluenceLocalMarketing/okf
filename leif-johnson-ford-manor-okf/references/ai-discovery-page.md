...
See [llms-txt.md](https://promptgraph.nyc3.cdn.digitaloceanspaces.com/OKF/leif-johnson-ford-manor/references/llms-txt.md) for the AI consumption directive and [prompts.md](https://promptgraph.nyc3.cdn.digitaloceanspaces.com/OKF/leif-johnson-ford-manor/references/prompts.md) for the prompt library.

...
The `/prompts` endpoint exposes 119 structured Q&A prompt/response pairs serving as an AI FAQ. See [prompts.md](https://promptgraph.nyc3.cdn.digitaloceanspaces.com/OKF/jake-sweeney-chevrolet/references/prompts.md) for the full library. Topics include:
...
See [testimonials.md](https://promptgraph.nyc3.cdn.digitaloceanspaces.com/OKF/jake-sweeney-chevrolet/references/testimonials.md) for customer review data.
...
See [llms-txt.md](https://promptgraph.nyc3.cdn.digitaloceanspaces.com/OKF/jake-sweeney-chevrolet/references/llms-txt.md) for the full llms.txt directive.
See [prompts.md](https://promptgraph.nyc3.cdn.digitaloceanspaces.com/OKF/jake-sweeney-chevrolet/references/prompts.md) for the complete Q&A prompt library.
See [testimonials.md](https://promptgraph.nyc3.cdn.digitaloceanspaces.com/OKF/jake-sweeney-chevrolet/references/testimonials.md) for customer review data.

...
Leif Johnson Ford of Buda maintains an [AI Discovery Hub](https://www.leifjohnsonfordofbuda.com/ai-discovery-hub/) with structured endpoints optimized for LLM and AI crawler consumption via PromptGraph.

## Global Directives

| Resource | URL |
|---|---|
| AI Manifest | `https://api.promptgraph.ai/api/v1/leif-johnson-buda/.well-known/ai-manifest.json` |
| llms.txt | `https://api.promptgraph.ai/api/v1/leif-johnson-buda/llms.txt` |
| robots.txt | `https://api.promptgraph.ai/api/v1/leif-johnson-buda/robots.txt` |
| Sitemap | `https://api.promptgraph.ai/api/v1/leif-johnson-buda/sitemap.xml` |
| Config | `https://api.promptgraph.ai/api/v1/leif-johnson-buda/config.json` |
...
See [llms-txt.md](https://github.com/ConfluenceLocalMarketing/okf/blob/main/leif-johnson-ford-buda-okf/references/llms-txt.md) for the AI consumption directive and [prompts.md](https://github.com/ConfluenceLocalMarketing/okf/blob/main/leif-johnson-ford-buda-okf/references/prompts.md) for the prompt library.

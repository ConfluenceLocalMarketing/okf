...
- [dealership.md](datasets/dealership.md) - Business profile, hours, contact, services, location, and special programs for Ron Marhofer Nissan in Cuyahoga Falls, OH
- [new-vehicles.md](datasets/new-vehicles.md) - New Nissan model lineup including Rogue, Altima, Sentra, Pathfinder, Frontier, Armada, Kicks, Murano, Maxima, Titan, Versa, Ariya, and LEAF
...
- [prompts.md](references/prompts.md) - Complete PromptGraph library of 62 structured Q&A prompts covering vehicles, financing, service, parts, and dealership info

## Tables

- [model-comparison.md](tables/model-comparison.md) - Side-by-side comparison of all new Nissan models including body type, drivetrain, seating, features, trims, towing, and warranty

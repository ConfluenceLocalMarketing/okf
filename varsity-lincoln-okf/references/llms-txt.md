...
See [ai-discovery-page.md](https://promptgraph.nyc3.cdn.digitaloceanspaces.com/OKF/varsity-lincoln/references/ai-discovery-page.md) for the full AI Discovery Hub overview.
See [prompts.md](https://promptgraph.nyc3.cdn.digitaloceanspaces.com/OKF/varsity-lincoln/references/prompts.md) for the prompt library.

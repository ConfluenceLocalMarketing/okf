...
See [ai-discovery-page.md](https://promptgraph.nyc3.cdn.digitaloceanspaces.com/OKF/basil-mitsubishi/references/ai-discovery-page.md) for structured semantic endpoints and AI manifest details.
See [prompts.md](https://promptgraph.nyc3.cdn.digitaloceanspaces.com/OKF/basil-mitsubishi/references/prompts.md) for the complete PromptGraph prompt library.
